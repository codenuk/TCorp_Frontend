...
class TableTasksStatus extends React.Component {
    ...
    async getData() {
        ...
        var tasks = await axios.get(`http://vanilla-erp.com:10000/api/v1/projects/T1901/tasks`, { headers: { 'x-access-token': token_auth } })
        ...
        this.state.tasks.map(function (task) {
            if (task.task_group_id !== prevTaskGroupId){
                ...
                table.push(
                    <tr ondrop="drop(event)" ondragover="allowDrop(event)">
                        ...
                        <td><i className="fas fa-caret-down icon-movement" onclick="myFunction(event)"></i></td>
                        <td colspan="5">
            ...
            table.push(
                <tr ondrop="drop(event)" ondragover="allowDrop(event)">
                    ...
                    <td></td>
                    <td><input type="text" className="form-control input-task" onkeyup="createNewRow(event)" onchange="saveValueAuto()" value={task.description} id={task.seq_no} /></td>
                    <td>
                    ...
                    <td><input type="date" className="form-control input-task" name="bday" value={task.deadline.substring(0,10)} /></td>
